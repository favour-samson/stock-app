    ...
    <div className="max-w-[1280px] px-[32px] h-auto md:h-[912px] bg-[#EAF8F8] md:bg-white mx-auto">
      <div className=" md:h-[752px]   ">
        <div className="flex-col flex md:flex-row items-center md:items-start justify-between">
          ...
          <p className="text-[14px] block text-center md:hidden max-w-[669px] text-[#3B4B4B] leading-[30px] pt-[16px]">
            Our blog is authored by a team of financial experts, market
            analysts, and traders
          </p>
          <Button text="view all posts" />
        </div>
        <p className="text-[20px]  hidden md:block max-w-[669px] text-[#3B4B4B] leading-[24px] pt-[20px]">
          Our blog is authored by a team of financial experts, market analysts,
          and traders
        </p>
