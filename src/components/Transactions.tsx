  ...
  return (
    <div className="dark:bg-[#131414]">
      <div className="md:mt-[280px]  mt-[130px] md:h-[492px] max-w-[1280px] mx-auto px-[11px] md:px-0">
        ...
        <div className="bg-secondary-300 dark:bg-[#131414] border border-[#FD891C] shadow-lg rounded-[16px] flex items-center justify-between md:h-[240px] mt-[48px] max-w-[1216px] mx-auto">
